...
Comments: WARNING! THIS DATABASE USES A LOT OF RAM!
	  There are over 1M nodes and 2M relations.
	  The database is 450MB. See the download section
*********************************************************
			Download the dump file
0.Visit this link to download the database .dump file:
  https://uccsoffice365-my.sharepoint.com/:u:/g/personal/ohumphre_uccs_edu/EQyAnbVhb5NMkF8oOHDHUZ4Brdy7Trz6oTJNaOYN4JbW_Q?e=KjPCpe


			Loading the database
0. INSTRUCTIONS ARE FOR WINDOWS, ADJUST ACCORDINGLY FOR OTHER OPERATING SYSTEMS
...
6. Start the database and wait for it to populate.
			...
			Viewing our data
0. To view our results, visit: https://neo4j-uccs-lego-db.herokuapp.com/ or click on the index.html file in this folder.
   More info can be found at https://github.com/OrionH/neo4j-uccs-lego-db


			Viewing cypher scripts

0. Open cypher files in the "Saved Cypher Scripts" folder by using a text editor. For more info, see the README in the folder.